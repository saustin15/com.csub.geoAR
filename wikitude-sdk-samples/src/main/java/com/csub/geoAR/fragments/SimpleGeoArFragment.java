 ...
 *
 * This Fragment needs Manifest.permission.ACCESS_FINE_LOCATION permissions
 * in addition to the required permissions of the SimpleArFragment.
 */
public class SimpleGeoArFragment extends SimpleArFragment implements LocationListener{
    ...
    private final LocationProvider.ErrorCallback errorCallback = new LocationProvider.ErrorCallback() {
        ...
        public void noProvidersEnabled() {
            Toast.makeText(getContext(), R.string.no_location_provider, Toast.LENGTH_LONG).show();
        }
    };
    ...
    private final ArchitectView.SensorAccuracyChangeListener sensorAccuracyChangeListener = new ArchitectView.SensorAccuracyChangeListener() {
        ...
        public void onCompassAccuracyChanged(int accuracy) {
            if ( accuracy < SensorManager.SENSOR_STATUS_ACCURACY_MEDIUM) { // UNRELIABLE = 0, LOW = 1, MEDIUM = 2, HIGH = 3
                Toast.makeText(getContext(), R.string.compass_accuracy_low, Toast.LENGTH_LONG ).show();
            }
        }
    };
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        locationProvider = new LocationProvider(getContext(), this, errorCallback);
    }
